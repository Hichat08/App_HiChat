...
export interface ChatState {
  ...
  openDirectConversation: (targetUserId: string) => Promise<string | null>;
  acceptDirectRequest: (conversationId: string) => Promise<void>;
  rejectDirectRequest: (conversationId: string) => Promise<void>;
